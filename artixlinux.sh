...
echo "${green}-- Formatting home partitions.${reset}"
...
basestrap /mnt base linux-lts runit elogind-runit artix-archlinux-support linux-headers linux-firmware base-devel git networkmanager networkmanager-runit bluez bluez-runit bluez-utils grub os-prober ntfs-3g efibootmgr
